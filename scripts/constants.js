...
export const TEMPLATES = {
  ...
  SETTINGS: `modules/${ID}/templates/settings.html`,
  ADD_CHARACTER_FORM: `modules/${ID}/templates/add-character.html`,
  REWARD_XP_FORM: `modules/${ID}/templates/reward-xp.html`,
